              ...
              <div class="card">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <h4 class="card-title">Cambio de datos de contacto.</h4>
                    <p class="card-description">Cambia aca todos o solo un dato de contacto.</p>
                    <div class="table-responsive">


                    <form id="formdatos" class="formdatos" action="" method="POST" enctype="multipart/form-data">             
                      <input type="text" name="nombre" placeholder="<?php echo $nombre ?>">
                      <input type="text" name="cel" placeholder="<?php echo $cel ?>">
                      <input type="text" name="correo" placeholder="<?php echo $correo ?>">
                      <input type="text" name="ciudad" placeholder="<?php echo $ciudad ?>">
                      <input type="text" name="direccion" placeholder="<?php echo $direccion ?>">


                    <div class="btnsfoton">
                      <button id="btndatos" type="submit" name="submit">Guardar Cambios</button>
                    </div>
