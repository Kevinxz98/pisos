            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="row">
                  <div class="col-md-12">
                    <div class="card-body">
                    <h4 class="card-title">Eliminar imágenes</h4>
                    <p class="card-description">Elimine las imágenes que desee de la galería.</p>
                    <div class="table-responsive">                      
                      <div class="conteg">
                        <?php while ($datagallery = mysqli_fetch_array($querygallery)) {
                          $imagen = '../../includes/img/uploads/'.$datagallery['nameimage'];
                          $id = $datagallery['id']; ?>

                        <div class="egimage">
                          <img src="<?php echo $imagen ?>">
                          <a class="delfoto" href="../../delfgallery.php?id=<?php echo $id ?>"><i class="mdi mdi-backspace"></i></a>
                        </div>
