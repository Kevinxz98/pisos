  ...
  if ($_POST) {
    ...
    if($_FILES['img1']){
      ...
      if($nombre_foton1 != '' || $nombre_foton1 != null){
        ...
        $imgfoton1_nombre = 'img_'.md5(date('YdjNBisLoBios'));
      ...
      $query_insertfoton1 = mysqli_query($conection, "INSERT INTO `fotosgallery`(`nameimage`) VALUES ('$imgfoton1_new')");
              ...
              <div class="card">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <form id="formgallery" class="formgallery" action="" method="POST" enctype="multipart/form-data">            
                    <div  class="input-box">
                    ...
                    <div class="btnsfoton">
                      <button id="btnsend" type="submit" name="submit">Guardar Cambios</button>
                    </div>
